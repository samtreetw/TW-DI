INSERT INTO room (room_id, name, description) values (0, 'lobby', 'lobby');

INSERT INTO room (room_id, name, description) values (1, 'room 1', 'This is room 1');

INSERT INTO room (room_id, name, description) values (2, 'room 2', 'This is room 2');

INSERT INTO room (room_id, name, description) values (3, 'room 3', 'This is room 3');
